import { Min,IsEmail, IsString, MinLength, IsNumber, IsInt, IsNotEmpty, IsAlpha, IsNumberString, Length} from 'class-validator';
...
export class UpdateHotelDto {
  ...
  @IsNotEmpty({message: 'El id nuevo no puede estar vacio'})
  idHotelero: User;
