...
Disponibilidad por rango (GET habitaciones/disponibles?desde&hasta) reutilizando tu lógica de solapes.
Historial/estado de reserva (activa, cancelada, completada) y filtros por usuario.
